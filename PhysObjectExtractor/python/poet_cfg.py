...
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring(
        ...
        'root://eospublic.cern.ch//eos/opendata/cms/Run2015D/DoubleEG/MINIAOD/08Jun2016-v1/00000/10447084-C86F-E611-AA78-0CC47A78A4B0.root'
        )
)
if isData:
...
process.hltHighLevel = cms.EDFilter("HLTHighLevel",
    ...
    HLTPaths = cms.vstring('HLT_DoubleEle8_CaloIdM_TrackIdM_Mass8_PFHT300*',
    "HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ*"),           # provide list of HLT paths (or patterns) you want
...
if isData:
	process.p = cms.Path(process.hltHighLevel+process.mymuons+process.mytaus+process.myphotons+process.mypvertex+process.mysimpletrig+
                             ...
                             process.uncorrectedMet+process.uncorrectedPatMet+process.Type1CorrForNewJEC+
                             process.slimmedMETsNewJEC+process.mymets+process.myelectrons
                             )
else:
	process.p = cms.Path(process.hltHighLevel+process.mymuons+process.mytaus+process.myphotons+process.mypvertex+process.mysimpletrig+
                             ...
                             process.Type1CorrForNewJEC+process.slimmedMETsNewJEC+process.mymets+process.myelectrons
                             )
